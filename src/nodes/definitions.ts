...
export const PRESETS: GraphPreset[] = [
    ...
    nodes: [
      {
        ...
        x: 80,
        y: 120,
        state: { value: 12, min: 0, max: 50, step: 1 },
        customLabel: '数値 A (幅)',
      },
      {
        id: 'n-slider-b',
        ...
        x: 80,
        y: 320,
        state: { value: 8, min: 0, max: 50, step: 1 },
        customLabel: '数値 B (高さ)',
      },
    ...
    nodes: [
      {
        ...
        x: 80,
        y: 160,
        state: { value: 21, min: 0, max: 100, step: 1 },
        customLabel: '入力年齢 (Age)',
      },
      {
        id: 'n-threshold',
        typeId: 'input/number',
      ...
      { id: 'n-branch', typeId: 'logic/branch', x: 740, y: 180, customLabel: '分岐処理' },
      {
        ...
        x: 740,
        y: 400,
        state: { trueLabel: '成人 (Adult)', falseLabel: '未成年 (Minor)' },
        customLabel: '成年判定バッジ',
      },
      {
        id: 'n-msg-out',
  ...
  },
  {
    ...
    nodes: [
      {
        ...
        x: 80,
        y: 220,
        state: { rawText: '15, -8, 24, -3, 50, -12', type: 'number' },
        customLabel: '入力数値リスト',
      },
      {
        id: 'n-arr-filter',
    ...
    connections: [
      {
        id: 'ca1',
        fromNodeId: 'n-arr-input',
        fromPortId: 'value',
        toNodeId: 'n-arr-filter',
        toPortId: 'arr',
      },
      {
        id: 'ca2',
        fromNodeId: 'n-arr-filter',
        fromPortId: 'result',
        toNodeId: 'n-arr-map',
        toPortId: 'arr',
      },
  ...
  },
  {
    ...
    nodes: [
      ...
      {
        id: 'n-user-ctor',
        typeId: 'type/User/constructor',
        x: 400,
        y: 240,
        customLabel: 'User Constructor (生成)',
      },
      // Validator node
      {
        id: 'n-user-val',
        typeId: 'type/User/validate',
        x: 740,
        y: 160,
        customLabel: 'User スキーマ検証',
      },
      // Deconstructor node
      {
        id: 'n-user-dcon',
        typeId: 'type/User/deconstruct',
        x: 1060,
        y: 240,
        customLabel: 'User Deconstruct (分解)',
      },
      // Inspector outputs
      {
        id: 'n-out-user-obj',
      ...
      },
      {
        ...
        x: 1060,
        y: 100,
        state: { trueLabel: 'User型 準拠', falseLabel: 'スキーマ不正' },
        customLabel: '検証ステータス',
      },
      {
        id: 'n-out-name',
    ...
    connections: [
      ...
      },
      {
        ...
        fromNodeId: 'n-user-ctor',
        fromPortId: 'instance',
        toNodeId: 'n-out-user-obj',
        toPortId: 'value',
      },
      {
        id: 'cu7',
        fromNodeId: 'n-user-val',
        fromPortId: 'isValid',
        toNodeId: 'n-out-val-status',
        toPortId: 'status',
      },
      {
        id: 'cu8',
        fromNodeId: 'n-user-ctor',
        fromPortId: 'instance',
        toNodeId: 'n-user-dcon',
        toPortId: 'instance',
      },
      {
        id: 'cu9',
        fromNodeId: 'n-user-dcon',
        fromPortId: 'name',
        toNodeId: 'n-out-name',
        toPortId: 'value',
      },
  ...
  },
  {
    ...
    nodes: [
      {
        ...
        x: 80,
        y: 160,
        state: { endpoint: '/api/v1/telemetry', latency: 400 },
        customLabel: '非同期APIフェッチ',
      },
      {
        id: 'np-await',
        typeId: 'async/await',
    ...
    connections: [
      ...
      {
        id: 'cp4',
        fromNodeId: 'np-get-metrics',
        fromPortId: 'value',
        toNodeId: 'np-out-metrics',
        toPortId: 'value',
      },
    ],
  },
    ...
    nodes: [
      {
        ...
        x: 80,
        y: 200,
        state: { intervalMs: 300, limit: 10 },
        customLabel: 'タイマーストリーム (0..9)',
      },
      {
        id: 'ns-filter',
